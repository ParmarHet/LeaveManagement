...
public class ManagerController : Controller
{
    ...
    public async Task<IActionResult> Review(int id)
    {
        ...
        var model = new LeaveApprovalViewModel
        {
            ...
            TotalDays = (leave.EndDate - leave.StartDate).TotalDays + 1,
            ActualDays = leave.ActualDays,
            HolidayCount = leave.HolidayCount,
            Reason = leave.RequestComments,
            DateRequested = leave.DateRequested,
            AvailableBalance = available,
            IsUnlimited = leave.LeaveType != null && (leave.LeaveType.Code == "LW" || leave.LeaveType.Code == "ML" || leave.LeaveType.Code == "BL"),
